...
# fmt: off
def missing_synch_schema(root: Union[str, ComplexPath], parent_dataset=None, autoload: bool = False) -> DotMap:
...
# fmt: off
def maat_schema(root: Union[str, ComplexPath], parent_dataset=None, autoload: bool = False) -> DotMap:
    """Builds a stream schema from a predefined structure.
